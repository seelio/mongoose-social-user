...
(function() {
  ...
  module.exports = function(schema, options) {
    var SocialUserData, SocialUserDataSchema, _findOrCreateUser, mongoose, socialReq;
    ...
    _findOrCreateUser = function(params, done) {
      ...
      return async.waterfall([
        function(cb) {
          var ref, ref1, userFindParams;
          userFindParams = {};
          userFindParams['auth.' + params.service + '.id'] = params.data.id;
          if (((ref = params.session) != null ? (ref1 = ref.auth) != null ? ref1.userId : void 0 : void 0) != null) {
            ...
            socialUserData: function(cb) {
              return async.waterfall([
                function(cb) {
                  ...
                  var error, j, len, service, serviceData;
                  if (socialUserData == null) {
                    return cb(null, null);
                  }
                  for (serviceData = j = 0, len = socialUserData.length; j < len; serviceData = ++j) {
                    service = socialUserData[serviceData];
                    if (typeof serviceData.contacts === 'string') {
                      try {
                  ...
                  var param, ref;
                  if (((ref = socialUserData[params.service]) != null ? ref.userData : void 0) == null) {
              ...
              removeServiceFromSocialGetParams = function(service) {
                ...
                for (requestType in socialGetParams) {
                  ...
                  if (socialGetParams[requestType] === 0) {
                    results1.push(delete socialGetParams[requestType]);
                  } else {
                ...
                return processingFunctions.push(function(cb) {
                  return async.filter(results.contacts[service], function(contact, cb) {
                    ...
                    return async.sortBy(contacts, function(contact, cb) {
                      var ref;
                      if (service === 'google') {
                        return cb(null, (ref = contact.entry.gd$name) != null ? ref.gd$familyName : void 0);
                      }
                      if (service === 'facebook') {
    ...
    schema.methods._refreshAccessToken = function(service, done) {
      ...
      return socialReq.get(this.id, {
        ...
        if ((ref = results.tokens[service]) != null ? ref.error : void 0) {
          err = new Error((ref1 = results.tokens[service]) != null ? ref1.error.message : void 0);
          err.code = (ref2 = results.tokens[service]) != null ? ref2.error.code : void 0;
          return done(err);
        }
