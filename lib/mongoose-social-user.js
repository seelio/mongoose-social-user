...
(function() {
  ...
  module.exports = function(schema, options) {
    ...
    socialReq.use('google', {
      consumerKey: options.google.consumerKey,
      consumerSecret: options.google.consumerSecret
    }).use('facebook', {
    ...
    schema.methods.getSocial = function(params, done) {
      ...
      return socialReq.get(this.id, params, function(err, results) {
        var processingFunctions, requestType;
        processingFunctions = [];
        for (requestType in results) {
          switch (requestType) {
            case 'google':
              if (results[service].contacts != null) {
                processingFunctions.push(function(cb) {
                  return async.filter(results[service].contacts, function(contact, cb) {
                    return cb(contact.email != null);
                  }, function(contacts) {
                    return async.sortBy(contacts, function(contact, cb) {
                      var _ref, _ref1;
                      console.log((_ref = contact.entry.gd$name) != null ? _ref.gd$familyName : void 0);
                      return cb(null, (_ref1 = contact.entry.gd$name) != null ? _ref1.gd$familyName : void 0);
