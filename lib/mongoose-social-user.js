            ...
            socialUserData: function(cb) {
              return async.waterfall([
                function(cb) {
                  ...
                  var service, serviceData, _i, _len;
                  if (socialUserData == null) {
                    return cb(null, null);
                  }
                  for (serviceData = _i = 0, _len = socialUserData.length; _i < _len; serviceData = ++_i) {
    ...
    schema.methods._refreshAccessToken = function(service, done) {
      ...
      return socialReq.get(this.id, {
        ...
        if ((_ref = results.tokens[service]) != null ? _ref.error : void 0) {
          err = new Error((_ref1 = results.tokens[service]) != null ? _ref1.error.message : void 0);
          err.code = (_ref2 = results.tokens[service]) != null ? _ref2.error.code : void 0;
          return done(err);
        }
