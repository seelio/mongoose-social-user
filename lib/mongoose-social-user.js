  ...
  module.exports = function(schema, options) {
    ...
    schema.methods.getSocial = function(params, done) {
      ...
      return self._socialReqGet(params, function(err, results) {
        var processingFunctions, requestType, secondTry, secondTryParams, secondTryServices, service;
        processingFunctions = [];
        secondTry = false;
        secondTryParams = {};
        secondTryServices = [];
              ...
              return self._socialReqGet(secondTryParams, function(err, secondResults) {
                ...
                for (requestType in secondResults) {
                  for (service in secondResults[requestType]) {
                    if (secondResults[requestType][service].error != null) {
                      return cb(secondResults[requestType][service].error);
                    }
